    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conversation', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='clusterization',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conversation', models.ForeignKey(blank=True, help_text='Conversation associated with the stereotype.', null=True,
                                                   on_delete=django.db.models.deletion.CASCADE, related_name='stereotypes',
                                                   to='ej_conversations.Conversation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choice', boogie.fields.enum_field.EnumField(ej_conversations.models.vote.Choice, verbose_name='Choice')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes', to='ej_clusters.Stereotype')),
                ('comment',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stereotype_votes', to='ej_conversations.Comment',
