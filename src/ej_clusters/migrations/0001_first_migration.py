    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "choice",
                    boogie.fields.enum_field.EnumField(ej_conversations.enums.Choice),
                ),
                (
                    "author",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="clusters", to="ej_clusters.Stereotype"
            ),
        ),
        migrations.AddField(
            model_name="cluster",
        ...
        migrations.AlterUniqueTogether(
            name="stereotype", unique_together={("name", "conversation")}
        ),
    ]
