...
def index(request, conversation, slug, check=check_promoted):
    ...
    clusters = (
        conversation.clusters
            ...
            .annotate_attr(size_pc=lambda obj: int(100 * obj.size / participants),
...
def edit(request, conversation, slug, check=check_promoted):
    ...
    # Decorate clusters
    clusters = clusterization.clusters.annotate_attr(form=lambda x: forms.ClusterForm(request=request, instance=x))
    groups = [
