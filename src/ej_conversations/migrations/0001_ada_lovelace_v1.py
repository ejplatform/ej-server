...
class Migration(migrations.Migration):
    ...
    replaces = [('ej_conversations', '0001_first_migration'), ('ej_conversations', '0002_change_meta_options'), ('ej_conversations', '0003_conversation_hidden'), ('ej_conversations', '0004_update_fields'), ('ej_conversations', '0005_auto_20190701_1443')]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='commentqueue',
            name='comments',
            field=models.TextField(blank=True, validators=[django.core.validators.RegexValidator(re.compile('^\\d+(?:,\\d+)*\\Z'), code='invalid', message='Enter only digits separated by commas.')]),
        ),
        migrations.AlterUniqueTogether(
            name='commentqueue',
