...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="ej_conversations_taggedconversation_items",
                        to="taggit.Tag",
                    ),
                ),
            ],
        ...
        migrations.AlterUniqueTogether(
            name="vote", unique_together={("author", "comment")}
        ),
        migrations.AlterUniqueTogether(
            name="commentqueue", unique_together={("conversation", "user")}
        ),
        migrations.AlterUniqueTogether(
            name="comment", unique_together={("conversation", "content")}
        ),
    ]
