# Generated by Django 2.0.6 on 2018-08-22 14:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ej_rocketchat.RCAccount')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rocketchat_subscription', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('url', models.URLField(default='localhost:3000', help_text='Public URL in which the Rocket.Chat instance is installed.', unique=True, verbose_name='Rocket.Chat URL')),
                ('api_url', models.URLField(help_text='A private URL used only for API calls. Can be used to override the public URL if Rocket.Chat is available in an internal address in your network.', unique=True, verbose_name='Rocket.Chat private URL')),
