...
class Migration(migrations.Migration):
    ...
    replaces = [('ej_profiles', '0001_first_migration'), ('ej_profiles', '0002_add_state_field'), ('ej_profiles', '0003_update_image_field')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_photo', models.ImageField(blank=True, null=True, upload_to='profile_images', verbose_name='Profile Photo')),
            ],
            options={
