    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', boogie.fields.enum_field.EnumField(ej_profiles.choices.Race, default=ej_profiles.choices.Race(0), is_string=False, verbose_name='Race')),
                ('gender', boogie.fields.enum_field.EnumField(ej_profiles.choices.Gender, default=ej_profiles.choices.Gender(0), is_string=False, verbose_name='Gender identity')),
