            ...
            fields=[
                ...
                (
                    ...
                    boogie.fields.enum_field.EnumField(
                        ej_notifications.enums.Purpose,
                        default=ej_notifications.enums.Purpose(0),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notification_option",
                    boogie.fields.enum_field.EnumField(
                        ej_notifications.enums.NotificationMode,
                        default=ej_notifications.enums.NotificationMode(0),
                        verbose_name="Notification options",
                    ),
                ),
                (
                    "user",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="raw_notificationsconfig",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
